...
public class CrimeListFragment extends Fragment {
    ...
    private class CrimeHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void bind(Crime crime) {
            ...
            mDateTextView.setText(new SimpleDateFormat("EEEE, dd MMMM yyyy, HH:mm").format(mCrime.getDate()));
...
//            startActivity(intent);
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mAddEmpty = view.findViewById(R.id.add_on_empty);
        mAddEmpty.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                addCrime();
            }
    ...
    public void updateUI() {
        ...
        if (mAdapter == null) {
            ...
            mAdapter.mCrimes = crimeLab.getCrimes();
